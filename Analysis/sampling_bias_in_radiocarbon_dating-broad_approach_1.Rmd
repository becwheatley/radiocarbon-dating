...
data <- AustArch %>%
  filter(Data.pertinent.for.time.series.analysis.or.calibration != "Unusuable") %>%
  filter(AGE_NORM != "NA") %>%
  filter(ERROR != "NA") %>%
  filter(METHOD == "Radiocarbon") %>%
  filter((Data.pertinent.for.time.series.analysis.or.calibration == "Marine" && AGE_NORM >= 400) 
