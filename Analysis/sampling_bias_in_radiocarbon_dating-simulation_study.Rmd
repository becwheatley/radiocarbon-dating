...
ggplot(NULL) +
  geom_ribbon(aes(x = spd.uniform$baseline$calBP, ymin = spd.uniform$envelope[[1]][,1], 
                  ymax = spd.uniform$envelope[[1]][,3]), fill = "#7FC97F", alpha = 0.3) +
  geom_line(aes(x = spd.uniform$baseline$calBP, y = spd.uniform$envelope[[1]][,2]), lwd = 1, color = "#7FC97F") +
...
ggplot(NULL) +
  geom_ribbon(aes(x = spd.singleton.ancient$baseline$calBP, ymin = spd.singleton.ancient$envelope[[1]][,1], 
                  ymax = spd.singleton.ancient$envelope[[1]][,3]), fill = "#BEAED4", alpha = 0.3) +
  geom_line(aes(x = spd.singleton.ancient$baseline$calBP, y = spd.singleton.ancient$envelope[[1]][,2]), lwd = 1, color = "#BEAED4") +
...
ggplot(NULL) +
  geom_ribbon(aes(x = spd.singleton.recent$baseline$calBP, ymin = spd.singleton.recent$envelope[[1]][,1], 
                  ymax = spd.singleton.recent$envelope[[1]][,3]), fill = "#FDC086", alpha = 0.3) +
  geom_line(aes(x = spd.singleton.recent$baseline$calBP, y = spd.singleton.recent$envelope[[1]][,2]), lwd = 1, color = "#FDC086") +
...
ggplot(NULL) +
  geom_ribbon(aes(x = spd.singleton.random$baseline$calBP, ymin = spd.singleton.random$envelope[[1]][,1], 
                  ymax = spd.singleton.random$envelope[[1]][,3]), fill = "#FFFF99", alpha = 0.3) +
  geom_line(aes(x = spd.singleton.random$baseline$calBP, y = spd.singleton.random$envelope[[1]][,2]), lwd = 1, color = "#FFFF99") +
...
ggplot(NULL) +
  geom_ribbon(aes(x = spd.bracketed$baseline$calBP, ymin = spd.bracketed$envelope[[1]][,1], 
                  ymax = spd.bracketed$envelope[[1]][,3]), fill = "#386CB0", alpha = 0.3) +
  geom_line(aes(x = spd.bracketed$baseline$calBP, y = spd.bracketed$envelope[[1]][,2]), lwd = 1, color = "#386CB0") +
...
ggplot(NULL) +
  geom_ribbon(aes(x = median.bin.age, ymin = fd.uniform$standardised.envelope[[1]][,1], 
                  ymax = fd.uniform$standardised.envelope[[1]][,3]), fill = "#7FC97F", alpha = 0.3) +
...
ggplot(NULL) +
  geom_ribbon(aes(x = median.bin.age, ymin = fd.singleton.ancient$standardised.envelope[[1]][,1], 
                  ymax = fd.singleton.ancient$standardised.envelope[[1]][,3]), fill = "#BEAED4", alpha = 0.3) +
...
ggplot(NULL) +
  geom_ribbon(aes(x = median.bin.age, ymin = fd.singleton.recent$standardised.envelope[[1]][,1], 
                  ymax = fd.singleton.recent$standardised.envelope[[1]][,3]), fill = "#FDC086", alpha = 0.3) +
...
ggplot(NULL) +
  geom_ribbon(aes(x = median.bin.age, ymin = fd.singleton.random$standardised.envelope[[1]][,1], 
                  ymax = fd.singleton.random$standardised.envelope[[1]][,3]), fill = "#FFFF99", alpha = 0.3) +
...
ggplot(NULL) +
  geom_ribbon(aes(x = median.bin.age, ymin = fd.bracketed$standardised.envelope[[1]][,1], 
                  ymax = fd.bracketed$standardised.envelope[[1]][,3]), fill = "#386CB0", alpha = 0.3) +
