---
title: "Sampling bias in radiocarbon dating project: simulation study (growth decline growth)"
...
## Simulating grownth then decline over time (_without_ taphonomic loss)
...
pop_trend  = "growth decline growth" ## the underlying population trend we want to mimic
```
...
ggplot(NULL) +
  ...
  ggtitle("SPD, growth decline then growth") +
...
ggplot(NULL) +
  ...
  ggtitle("Freq dist of dates in bins, growth decline then growth") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
ggplot(NULL) +
  ...
  geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.noloss.sites), lwd = 1, 
              colour = "black", linetype = "dashed", df = 40) +
  labs(x = "Years cal BP", y = "Standardised frequency (frequency/sum(frequency) for each sample)") +
  ggtitle("Freq dist of sites in bins, growth decline then growth") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
ggplot(NULL) +
  ...
  geom_line(aes(x = spd.baseline.taphloss$grid$calBP, y = spd.baseline.noloss$grid$PrDens), lwd = 0.5, colour = "black", 
            linetype = "dashed") +
  labs(x = "Years cal BP", y = "Probability") +
  ggtitle("SPD, growth decline then growth + taphonomic loss") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
ggplot(NULL) +
  ...
  geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.taphloss), lwd = 1, 
    ...
    geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.noloss), lwd = 0.5, 
              colour = "black", linetype = "dashed", df = 40) +
  labs(x = "Years cal BP", y = "Standardised frequency (frequency/sum(frequency) for each sample)") +
  ggtitle("Freq dist of dates in bins, growth decline then growth + taphonomic loss w. correction") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
ggplot(NULL) +
  ...
  geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.taphloss), lwd = 1, 
    ...
    geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.noloss), lwd = 0.5, 
              colour = "black", linetype = "dashed", df = 40) +
  labs(x = "Years cal BP", y = "Standardised frequency (frequency/sum(frequency) for each sample)") +
  ggtitle("Freq dist of dates in bins, growth decline then growth + taphonomic loss w/o correction") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
ggplot(NULL) +
  ...
  geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.taphloss.sites), lwd = 1, 
    ...
    geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.noloss.sites), lwd = 0.5, 
              colour = "black", linetype = "dashed", df = 40) +
  labs(x = "Years cal BP", y = "Standardised frequency (frequency/sum(frequency) for each sample)") +
  ggtitle("Freq dist of sites in bins, growth decline then growth + taphonomic loss") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```