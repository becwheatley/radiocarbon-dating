#-------------------------------------------------------------------------------------------------------------------------------------------
# title: "Sampling bias in radiocarbon dating project: simulation study (exponential population growth) - baseline SPD vs mean subsample SPDs"
...
# Save the workspace
save.image("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-99sims.RData")

#--------------------------------------------------------------------------------------
# II. COMPARE THE SPD FOR THE BASELINE DATA TO THE MEAN SPD FOR EACH BIASED SUBSAMPLE
#--------------------------------------------------------------------------------------

# Set the running mean to use for the SPDs
runm = 100

# Get the SPD for the first set of baseline data (used to create the subsets)
spd.baseline.noloss1 <- spd(x = cal.baseline.noloss1, timeRange = timeRange, runm = runm, spdnormalised = normalised)

# Get the mean and 95% CI for the SPDs for the baseline data sets
...
# Get the mean and 95% CI for the SPDs for the subsampled data sets
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5samples_99sims.csv")
...
write.csv(plot.spd.noloss, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Exponential population growth/Plot_data-SPD-5samples_99sims.csv")
...
# Save the workspace
save.image("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data_plus_SPDs-5s-99sims.RData")
