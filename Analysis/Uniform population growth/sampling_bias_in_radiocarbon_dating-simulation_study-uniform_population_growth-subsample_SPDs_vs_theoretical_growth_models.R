...
load("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Uniform population growth/uniform_pop_growth-raw_sample_and_calibrated_data-5s-5sims.RData")
...
for (i in sl:(sl+subnum-1)){
  ...
  if (i%%(sl-1) > 0) { index <- i%%(sl-1)} else { index <- subnum }
    ...
    uniform  <- modelTest(cal.uniform.75p[[index]], errors = sample.uniform.75p[[index]]$error, nsim = nsim, timeRange = timeRange, 
                        model = "uniform", runm = runm, raw = TRUE, ncores = ncores)
  p_values <- calculate_p_value(uniform, sample_type = "uniform (75% sites)", replicate = i, theoretical_model = "uniform")
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-uniform_75p_", index, "_vs_uniform-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-uniform_75p_", index, "_vs_linear-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-uniform_75p_", index, "_vs_exponential-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  uniform  <- modelTest(cal.uniform.100p[[index]], errors = sample.uniform.100p[[index]]$error, nsim = nsim, timeRange = timeRange, 
                        model = "uniform", runm = runm, raw = TRUE, ncores = ncores)
  p_values <- calculate_p_value(uniform, sample_type = "uniform (100% sites)", replicate = i, theoretical_model = "uniform")
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-uniform_100p_", index, "_vs_uniform-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-uniform_100p_", index, "_vs_linear-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-uniform_100p_", index, "_vs_exponential-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  uniform  <- modelTest(cal.singleton.ancient.50p[[index]], errors = sample.singleton.ancient.50p[[index]]$error, nsim = nsim, timeRange = timeRange, 
                        model = "uniform", runm = runm, raw = TRUE, ncores = ncores)
  p_values <- calculate_p_value(uniform, sample_type = "singleton ancient (50% sites)", replicate = i, theoretical_model = "uniform")
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-singleton_ancient_50p_", index, "_vs_uniform-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-singleton_ancient_50p_", index, "_vs_linear-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-singleton_ancient_50p_", index, "_vs_exponential-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  uniform  <- modelTest(cal.singleton.ancient.75p[[index]], errors = sample.singleton.ancient.75p[[index]]$error, nsim = nsim, timeRange = timeRange, 
                        model = "uniform", runm = runm, raw = TRUE, ncores = ncores)
  p_values <- calculate_p_value(uniform, sample_type = "singleton ancient (75% sites)", replicate = i, theoretical_model = "uniform")
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-singleton_ancient_75p_", index, "_vs_uniform-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-singleton_ancient_75p_", index, "_vs_linear-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-singleton_ancient_75p_", index, "_vs_exponential-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  uniform  <- modelTest(cal.singleton.ancient.100p[[index]], errors = sample.singleton.ancient.100p[[index]]$error, nsim = nsim, timeRange = timeRange, 
                        model = "uniform", runm = runm, raw = TRUE, ncores = ncores)
  p_values <- calculate_p_value(uniform, sample_type = "singleton ancient (100% sites)", replicate = i, theoretical_model = "uniform")
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-singleton_ancient_100p_", index, "_vs_uniform-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-singleton_ancient_100p_", index, "_vs_linear-5s-499sims.png"))
...
for (i in sl:(sl+subnum-1)){
  ...
  ggsave(p_values$plot2, 
         file = paste0("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Subsamples vs theoretical growth models/Uniform population growth/Uniform 50p/uniform_pop_growth-singleton_ancient_100p_", index, "_vs_exponential-5s-499sims.png"))
...
# Save relevant files!!!!!!!!!!!!!!!
save.image("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Uniform population growth/uniform_pop_growth-partial1.RData")
