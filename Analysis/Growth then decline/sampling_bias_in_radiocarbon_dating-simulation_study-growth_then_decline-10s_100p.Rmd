---
title: "Sampling bias in radiocarbon dating project: simulation study (growth then decline) - 10 samples at 100%"
...
## Simulating growth then decline over time (_without_ taphonomic loss)
...
* solid coloured line is the median SPD for the sampled data set  
  + teal = 5 uniformly selected samples from 100% of sites  
  + orange = only the most ancient sample from 100% of sites  
  + blue = only the most recent sample from 100% of sites  
  + pink = one random sample from 100% of sites  
  + green = only the most recent and most ancient sample from 100% of sites (bracketed)  
...
ggplot(NULL) +
  ...
  ggtitle("SPD, growth then decline") +
...
ggplot(NULL) +
  ...
  ggtitle("Freq dist of dates in bins, growth then decline") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
ggplot(NULL) +
  ...
  geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.noloss.sites), lwd = 1, 
              colour = "black", linetype = "dashed", df = 40) +
  labs(x = "Years cal BP", y = "Standardised frequency (frequency/sum(frequency) for each sample)") +
  ggtitle("Freq dist of sites in bins, growth then decline") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
## Simulating growth then decline over time (_with_ taphonomic loss)
...
ggplot(NULL) +
  ...
  geom_line(aes(x = spd.baseline.taphloss$grid$calBP, y = spd.baseline.noloss$grid$PrDens), lwd = 0.5, colour = "black", 
            linetype = "dashed") +
  labs(x = "Years cal BP", y = "Probability") +
  ggtitle("SPD, growth then decline + taphonomic loss") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
ggplot(NULL) +
  ...
  geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.taphloss), lwd = 1, 
    ...
    geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.noloss), lwd = 0.5, 
              colour = "black", linetype = "dashed", df = 40) +
  labs(x = "Years cal BP", y = "Standardised frequency (frequency/sum(frequency) for each sample)") +
  ggtitle("Freq dist of dates in bins, growth then decline + taphonomic loss w. correction") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
ggplot(NULL) +
  ...
  geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.taphloss), lwd = 1, 
    ...
    geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.noloss), lwd = 0.5, 
              colour = "black", linetype = "dashed", df = 40) +
  labs(x = "Years cal BP", y = "Standardised frequency (frequency/sum(frequency) for each sample)") +
  ggtitle("Freq dist of dates in bins, growth then decline + taphonomic loss w/o correction") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```
...
ggplot(NULL) +
  ...
  geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.taphloss.sites), lwd = 1, 
    ...
    geom_spline(aes(x = median.bin.age, y = standardised.baseline.freq.noloss.sites), lwd = 0.5, 
              colour = "black", linetype = "dashed", df = 40) +
  labs(x = "Years cal BP", y = "Standardised frequency (frequency/sum(frequency) for each sample)") +
  ggtitle("Freq dist of sites in bins, growth then decline + taphonomic loss") +
  scale_x_reverse(breaks = seq(12200, 200, by = -6000), limits = c(12200, 200)) +
  theme_bw()
```