#-------------------------------------------------------------------------------------------------------------------------------------------
# title: "Sampling bias in radiocarbon dating project: simulation study (growth then decline) - 5 samples"
...
pop_trend        = "growth then decline" ## the underlying population trend we want to mimic
...
write.csv(plot.spd.noloss, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Growth then decline/Plot_data-SPD_noloss-5samples_20sims.csv")
...
baseline <- plot.spd.noloss[plot.spd.noloss$sample %in% c("baseline (no loss)", "baseline (no loss) replicates"),] %>%
  ...
  ylim(0, 0.0005) +
  scale_x_reverse(breaks = seq(12200/1000, 200/1000, by = -6000/1000), limits = c(12200/1000, 200/1000))
spd.noloss <- ggarrange(uniform, singleton.random, singleton.ancient, singleton.recent, bracketed,
                    labels = c("A", "B", "C", "D", "E"),
                    ncol = 2, nrow = 3)
spd.noloss
ggexport(spd.noloss, filename = "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Growth_then_decline-SPD_noloss-5samples_20sims.png",
         width = 1500,
         height = 1000)
...
write.csv(plot.fd.samples.noloss, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Growth then decline/Plot_data-FD_samples_noloss-5samples_20sims.csv")
...
fd.samples.noloss <- ggarrange(uniform, singleton.random, singleton.ancient, singleton.recent, bracketed, baseline,
                     ...
                     ncol = 2, nrow = 3)
fd.samples.noloss
ggexport(fd.samples.noloss, filename = "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Growth_then_decline-FD_samples_noloss-5samples_20sims.png",
         width = 1500,
         height = 1000)
...
write.csv(plot.fd.sites.noloss, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Growth then decline/Plot_data-FD_sites_no_loss-5samples_20sims.csv")
...
fd.sites.noloss <- ggarrange(uniform, singleton.random, singleton.ancient, singleton.recent, bracketed, baseline,
                             ...
                             ncol = 2, nrow = 3)
fd.sites.noloss
ggexport(fd.sites.noloss, filename = "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Growth_then_decline-FD_sites_noloss-5samples_20sims.png",
         width = 1500,
         height = 1000)
...
write.csv(plot.spd.taphloss, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Growth then decline/Plot_data-SPD_taphloss-5samples_20sims.csv")
...
spd.taphloss <- ggarrange(uniform, singleton.random, singleton.ancient, singleton.recent, bracketed, baseline,
                        ...
                        ncol = 2, nrow = 3)
spd.taphloss
ggexport(spd.taphloss, filename = "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Growth_then_decline-SPD_taphloss-5samples_20sims.png",
         width = 1500,
         height = 1000)
...
write.csv(plot.fd.samples.taphloss.correct, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Growth then decline/Plot_data-FD_samples_taphloss_corrected-5samples_20sims.csv")
...
ggexport(fd.samples.taphloss.correct, filename = "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Growth_then_decline-FD_samples_taphloss_corrected-5samples_20sims.png",
         width = 1500,
         height = 1000)
...
write.csv(plot.fd.samples.taphloss.uncorrect, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Growth then decline/Plot_data-FD_samples_taphloss_uncorrected-5samples_20sims.csv")
...
ggexport(fd.samples.taphloss.uncorrect, filename = "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Growth_then_decline-FD_samples_taphloss_uncorrected-5samples_20sims.png",
         width = 1500,
         height = 1000)
...
write.csv(plot.fd.sites.taphloss, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Growth then decline/Plot_data-FD_sites_taphloss-5samples_20sims.csv")
...
fd.sites.taphloss <- ggarrange(uniform, singleton.random, singleton.ancient, singleton.recent, bracketed, baseline,
                                           ...
                                           ncol = 2, nrow = 3)
fd.sites.taphloss
ggexport(fd.sites.taphloss, filename = "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Growth_then_decline-FD_sites_taphloss-5samples_20sims.png",
         width = 1500,
         height = 1000)
