---
title: "Sampling bias in radiocarbon dating project: simulation study (growth then decline) - 10 samples at 75%"
...
```{r}
percent_sites   = 75   ## the number of sites we want to apply the sampling method across (the remainder will be 
...
* solid coloured line is the median SPD for the sampled data set  
  + teal = 5 uniformly selected samples from 75% of sites  
  + orange = only the most ancient sample from 75% of sites  
  + blue = only the most recent sample from 75% of sites  
  + pink = one random sample from 75% of sites  
  + green = only the most recent and most ancient sample from 75% of sites (bracketed)  
