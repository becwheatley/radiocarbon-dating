---
title: "Sampling bias in radiocarbon dating project: simulation study (no population change) - 10 samples at 75%"
...
* solid coloured line is the median SPD for the sampled data set  
  + teal = 3 uniformly selected samples from 100% of sites  
...
* ribbon is the 95% confidence interval for the sampled data set (note that when 100% of sites are sampled, some of the subsamples will not have confidence intervals)   
