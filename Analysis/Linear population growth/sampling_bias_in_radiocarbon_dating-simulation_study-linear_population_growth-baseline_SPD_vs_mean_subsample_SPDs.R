...
# Save the workspace
save.image("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Linear population growth/linear_pop_growth-raw_sample_and_calibrated_data-5s-99sims.RData")
