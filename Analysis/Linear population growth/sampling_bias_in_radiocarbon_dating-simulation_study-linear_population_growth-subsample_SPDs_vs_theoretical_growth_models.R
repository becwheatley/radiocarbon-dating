...
correctly_identified[1:45,2] <- "linear"
...
uniform.50p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="uniform_50p", true_model="Linear") # fit and return the best growth model (based on a selected bin width)
uniform.50p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="uniform_50p", true_model="Linear") # fit and return best growth model based on KDE Gaussian smoothing of the dates
rm(cal.uniform.50p)
load("E:/Radiocarbon dating analysis/Analysis/Linear population growth/linear_pop_growth-spds-UNIFORM_50P.RData")
uniform.50p.spd <- fit_models_spd(spd.uniform.50p, show_plot=FALSE, sampling_type="uniform_50p", true_model="Linear")
rm(spd.uniform.50p)
...
write.csv(correctly_identified, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/linear_pop_growth-samples_vs_theoretical_growth_models-5s-1000sims-summary.csv")
...
uniform.75p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="uniform_75p", true_model="Linear")
uniform.75p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="uniform_75p", true_model="Linear")
rm(cal.uniform.75p)
load("E:/Radiocarbon dating analysis/Analysis/Linear population growth/linear_pop_growth-spds-UNIFORM_75P.RData")
uniform.75p.spd <- fit_models_spd(spd.uniform.75p, show_plot=FALSE, sampling_type="uniform_75p", true_model="Linear")
rm(spd.uniform.75p)
rm(spd.baseline.noloss1)
...
uniform.100p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="uniform_100p", true_model="Linear")
uniform.100p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="uniform_100p", true_model="Linear")
rm(cal.uniform.100p)
load("E:/Radiocarbon dating analysis/Analysis/Linear population growth/linear_pop_growth-spds-UNIFORM_100P.RData")
uniform.100p.spd <- fit_models_spd(spd.uniform.100p, show_plot=FALSE, sampling_type="uniform_100p", true_model="Linear")
rm(spd.uniform.100p)
rm(spd.baseline.noloss1)
...
singleton.ancient.50p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="singleton_ancient_50p", true_model="Linear")
singleton.ancient.50p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="singleton_ancient_50p", true_model="Linear")
...
singleton.ancient.50p.spd <- fit_models_spd(spd.singleton.ancient.50p, show_plot=FALSE, sampling_type="singleton_ancient_50p", true_model="Linear")
...
singleton.ancient.75p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="singleton_ancient_75p", true_model="Linear")
singleton.ancient.75p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="singleton_ancient_75p", true_model="Linear")
...
singleton.ancient.75p.spd <- fit_models_spd(spd.singleton.ancient.75p, show_plot=FALSE, sampling_type="singleton_ancient_75p", true_model="Linear")
...
singleton.ancient.100p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="singleton_ancient_100p", true_model="Linear")
singleton.ancient.100p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="singleton_ancient_100p", true_model="Linear")
...
singleton.ancient.100p.spd <- fit_models_spd(spd.singleton.ancient.100p, show_plot=FALSE, sampling_type="singleton_ancient_100p", true_model="Linear")
...
singleton.random.50p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="singleton_random_50p", true_model="Linear")
singleton.random.50p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="singleton_random_50p", true_model="Linear")
...
singleton.random.50p.spd <- fit_models_spd(spd.singleton.random.50p, show_plot=FALSE, sampling_type="singleton_random_50p", true_model="Linear")
...
singleton.random.75p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="singleton_random_75p", true_model="Linear")
singleton.random.75p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="singleton_random_75p", true_model="Linear")
...
singleton.random.75p.spd <- fit_models_spd(spd.singleton.random.75p, show_plot=FALSE, sampling_type="singleton_random_75p", true_model="Linear")
...
singleton.random.100p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="singleton_random_100p", true_model="Linear")
singleton.random.100p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="singleton_random_100p", true_model="Linear")
...
singleton.random.100p.spd <- fit_models_spd(spd.singleton.random.100p, show_plot=FALSE, sampling_type="singleton_random_100p", true_model="Linear")
...
singleton.recent.50p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="singleton_recent_50p", true_model="Linear")
singleton.recent.50p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="singleton_recent_50p", true_model="Linear")
...
singleton.recent.50p.spd <- fit_models_spd(spd.singleton.recent.50p, show_plot=FALSE, sampling_type="singleton_recent_50p", true_model="Linear")
...
singleton.recent.75p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="singleton_recent_75p", true_model="Linear")
singleton.recent.75p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="singleton_recent_75p", true_model="Linear")
...
singleton.recent.75p.spd <- fit_models_spd(spd.singleton.recent.75p, show_plot=FALSE, sampling_type="singleton_recent_75p", true_model="Linear")
...
singleton.recent.100p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="singleton_recent_100p", true_model="Linear")
singleton.recent.100p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="singleton_recent_100p", true_model="Linear")
...
singleton.recent.100p.spd <- fit_models_spd(spd.singleton.recent.100p, show_plot=FALSE, sampling_type="singleton_recent_100p", true_model="Linear")
...
bracketed.50p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="bracketed_50p", true_model="Linear")
bracketed.50p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="bracketed_50p", true_model="Linear")
...
bracketed.50p.spd <- fit_models_spd(spd.bracketed.50p, show_plot=FALSE, sampling_type="bracketed_50p", true_model="Linear")
...
bracketed.75p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="bracketed_75p", true_model="Linear")
bracketed.75p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="bracketed_75p", true_model="Linear")
...
bracketed.75p.spd <- fit_models_spd(spd.bracketed.75p, show_plot=FALSE, sampling_type="bracketed_75p", true_model="Linear")
...
bracketed.100p.binned <- fit_models_binned(cal_dates, bin_width=500, show_plot=FALSE, sampling_type="bracketed_100p", true_model="Linear")
bracketed.100p.kde    <- fit_models_kde(cal_dates, show_plot=FALSE, sampling_type="bracketed_100p", true_model="Linear")
...
bracketed.100p.spd <- fit_models_spd(spd.bracketed.100p, show_plot=FALSE, sampling_type="bracketed_100p", true_model="Linear")
...
write.csv(best.models, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/linear_pop_growth-samples_vs_theoretical_growth_models-5s-1000sims.csv")
