...
# Save the workspace
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_data-5s-1000sims.RData")
#load("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_data-5s-1000sims.RData")
...
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-BASELINE_ONLY.RData")
...
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-UNIFORM_50P.RData")
rm(cal.uniform.50p)

cal.uniform.75p     <- calibrate_samples(samples = sample.uniform.75p, 
                                         normalised = normalised, 
                                         ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-UNIFORM_75P.RData")
rm(cal.uniform.75p)

cal.uniform.100p    <- calibrate_samples(samples = sample.uniform.100p, 
                                         normalised = normalised, 
                                         ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-UNIFORM_100P.RData")
rm(cal.uniform.100p)
...
cal.singleton.ancient.50p  <- calibrate_samples(samples = sample.singleton.ancient.50p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-SINGLETON_ANCIENT_50P.RData")
rm(cal.singleton.ancient.50p)

cal.singleton.ancient.75p  <- calibrate_samples(samples = sample.singleton.ancient.75p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-SINGLETON_ANCIENT_75P.RData")
rm(cal.singleton.ancient.75p)

cal.singleton.ancient.100p <- calibrate_samples(samples = sample.singleton.ancient.100p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-SINGLETON_ANCIENT_100P.RData")
...
cal.singleton.recent.50p   <- calibrate_samples(samples = sample.singleton.recent.50p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-SINGLETON_RECENT_50P.RData")
rm(cal.singleton.recent.50p)

cal.singleton.recent.75p   <- calibrate_samples(samples = sample.singleton.recent.75p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-SINGLETON_RECENT_75P.RData")
rm(cal.singleton.recent.75p)

cal.singleton.recent.100p  <- calibrate_samples(samples = sample.singleton.recent.100p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-SINGLETON_RECENT_100P.RData")
rm(cal.singleton.recent.100p)

cal.singleton.random.50p   <- calibrate_samples(samples = sample.singleton.random.50p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-SINGLETON_RANDOM_50P.RData")
rm(cal.singleton.random.50p)

cal.singleton.random.75p   <- calibrate_samples(samples = sample.singleton.random.75p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-SINGLETON_RANDOM_75P.RData")
rm(cal.singleton.random.75p)

cal.singleton.random.100p  <- calibrate_samples(samples = sample.singleton.random.100p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-SINGLETON_RANDOM_100P.RData")
rm(cal.singleton.random.100p)

cal.bracketed.50p          <- calibrate_samples(samples = sample.bracketed.50p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-BRACKETED_50P.RData")
rm(cal.bracketed.50p)

cal.bracketed.75p          <- calibrate_samples(samples = sample.bracketed.75p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-BRACKETED_75P.RData")
rm(cal.bracketed.75p)

cal.bracketed.100p         <- calibrate_samples(samples = sample.bracketed.100p, 
                                                normalised = normalised, 
                                                ncores = ncores)
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-BRACKETED_100P.RData")
rm(cal.bracketed.100p)

# Save the workspace
#save.image("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims.RData")
...
load("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data-5s-1000sims-BASELINE_ONLY.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-BASELINE_ONLY.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-BASELINE_ONLY.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-UNIFORM_50P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-UNIFORM_50P.RData")
rm(spd.uniform.50p)
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-UNIFORM_75P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-UNIFORM_75P.RData")
rm(spd.uniform.75p)
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-UNIFORM_100P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-UNIFORM_100P.RData")
rm(spd.uniform.100p)
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-SINGLETON_ANCIENT_50P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-SINGLETON_ANCIENT_50P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-SINGLETON_ANCIENT_75P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-SINGLETON_ANCIENT_75P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-SINGLETON_ANCIENT_100P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-SINGLETON_ANCIENT_100P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-SINGLETON_RECENT_50P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-SINGLETON_RECENT_50P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-SINGLETON_RECENT_75P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-SINGLETON_RECENT_75P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-SINGLETON_RECENT_100P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-SINGLETON_RECENT_100P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-SINGLETON_RANDOM_50P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-SINGLETON_RANDOM_50P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-SINGLETON_RANDOM_75P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-SINGLETON_RANDOM_75P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-SINGLETON_RANDOM_100P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-SINGLETON_RANDOM_100P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-BRACKETED_50P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-BRACKETED_50P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-BRACKETED_75P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-BRACKETED_75P.RData")
...
write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims-BRACKETED_100P.csv")
save.image("E:/Radiocarbon dating analysis/Analysis/Exponential population growth/exponential_pop_growth-spds-BRACKETED_100P.RData")
...
# 
# write.csv(pvals, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Results/Baseline vs subsamples/exponential_pop_growth-baseline_SPD_vs_mean_subsample_SPDs-5ssamples_1000sims.csv")
# 
# #------------------------------------------------------------
...
# }
# 
# write.csv(plot.spd.noloss, "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Exponential population growth/Exponential_pop_growth-plot_data-SPD-5samples_1000sims.csv")
# 
# # Plot (combined):
...
#                         common.legend = TRUE)
# spd.noloss
# ggexport(spd.noloss, filename = "C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Figures/Exponential_population_growth-baseline_SPD_vs_mean_subsamples-5samples_1000sims.png",
#          width = 1500,
#          height = 1000)
# 
# # Save the workspace
# save.image("C:/Users/Bec/Work/Projects/Radiocarbon dating/GitHub/Analysis/Exponential population growth/exponential_pop_growth-raw_sample_and_calibrated_data_plus_SPDs-5s-1000sims.RData")