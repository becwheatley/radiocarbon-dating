...
uniform.50p.spd <- fit_models_spd(spd.uniform.50p, show_plot=FALSE, sampling_type="uniform_50p", true_model="Null")
rm(spd.uniform.50p)
...
uniform.75p.spd <- fit_models_spd(spd.uniform.75p, show_plot=FALSE, sampling_type="uniform_75p", true_model="Null")
rm(spd.uniform.75p)
rm(spd.baseline.noloss1)
...
uniform.100p.spd <- fit_models_spd(spd.uniform.100p, show_plot=FALSE, sampling_type="uniform_100p", true_model="Null")
rm(spd.uniform.100p)
rm(spd.baseline.noloss1)
